# -*- coding: utf-8 -*- 
# This script will run VIBE on given set of images 
# Copied from https://github.com/mkocabas/VIBE/demo.py
# Original demo is modified accoriding to my purpose
# changes
#  - will accept images dir / set of images instead of video file # TODO - Need to check with openpose
...
from lib.vibe.models.vibe import VIBE_Demo
from lib.vibe.utils.renderer import Renderer
from lib.vibe.dataset.inference import Inference
from lib.vibe.utils.smooth_pose import smooth_pose
from lib.vibe.data_utils.kp_utils import convert_kps
from lib.vibe.utils.pose_tracker import run_posetracker

from lib.vibe.utils.demo_utils import (
