...
import lib.objectDetectionMetrics._init_paths
from lib.objectDetectionMetrics.BoundingBox import BoundingBox
from lib.objectDetectionMetrics.BoundingBoxes import BoundingBoxes
from lib.objectDetectionMetrics.Evaluator import *
from lib.objectDetectionMetrics.utils import BBFormat
    ...
    for f in files:
        ...
        for line in fh1:
            ...
            if isGT:
                ...
                # addinc confidence score to the GT
...
parser.add_argument('-gt_t',
                    '--groundtruth_thresh',
                    dest='gt_t',
                    type=float,
                    default=0.0,
                    # metavar='',
                    help='Ground Truth Threshold. Default 0.0')

parser.add_argument('-det_t',
                    '--detection_thresh',
                    dest='det_t',
                    type=float,
                    default=0.0,
                    # metavar='',
                    help='Detection Threshold. Default 0.0')
...
def calculateAP(gtFolder, predFolder,gt_t=0.75, det_t=0.5):
    # iouThreshold = args.iouThreshold
    iouThreshold = 0.5
    # gt_t = 0.75 #args.gt_t
    # det_t = 0.0 #args.det_t
    args.gt_t = gt_t
    args.det_t = det_t
    args.gtFolder = gtFolder
    args.detFolder = predFolder
...
if __name__ == "__main__" :
    gtFolder = "/home/akunchala/Documents/PhDStuff/PrivacyFramework/groundtruths"
    predFolder = "/home/akunchala/Documents/PhDStuff/PrivacyFramework/annomizedImgs/blur_body_detections"
    calculateAP(gtFolder,predFolder)