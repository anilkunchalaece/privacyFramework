...
from lib.vibe.utils.utils import move_dict_to_device, AverageMeter

from lib.vibe.utils.eval_utils import (
    compute_accel,
    compute_error_accel,
    compute_error_verts,
...
class Trainer():
    ...
    def train(self):
        ...
        for i in range(self.num_iters_per_epoch):
            ...
            if self.debug:
                print('==== Visualize ====')
                from lib.vibe.utils.vis import batch_visualize_vid_preds
