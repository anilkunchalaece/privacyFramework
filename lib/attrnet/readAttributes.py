...
def listAllAttributes(save_dir) :
    # fileName -> processed pickle file location
    fileName = os.path.join(save_dir,'dataset.pkl')
...
if __name__ == "__main__":
    # save_dir = './data/RAP2/'
    save_dir = '/home/akunchala/Documents/z_Datasets/RAP'
    reorder = True
    # generate_data_description(save_dir, reorder)
    listAllAttributes(save_dir)