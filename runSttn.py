# -*- coding: utf-8 -*-
# This scipt will run STTN for given set of images
# code copied from https://github.com/researchmm/STTN/test.py
# Original test.py is modified according my purpose
